...
export default function AdminNavbarLinks() {
  ...
  const handleClickSetting = event => {
    if (openSetting && openSetting.contains(event.target)) {
      setOpenSetting(null);
    } else {
    ...
    <div>
      ...
      <div className={classes.manager}>
        <Button
          ...
          aria-owns={openLanguage ? "profile-menu-list-grow" : null}
          aria-haspopup="true"
        ...
        >
          {({ TransitionProps, placement }) => (
            ...
            >
              <Paper>
                <ClickAwayListener onClickAway={handleCloseLangage}>
                  <MenuList role="menu">
                    <MenuItem
                      onClick={handleCloseLangage}
      ...
      <div className={classes.manager}>
        <Button
          ...
          className={classes.buttonLink}
        >
          <Setting className={classes.icons} />
          <Hidden mdUp implementation="css">
            ...
            >
              <Paper>
                <ClickAwayListener onClickAway={handleCloseSetting}>
                  <MenuList role="menu">
                    <MenuItem
                      onClick={() => redirectionPage('/administrateur/habilitation')}
                      className={classes.dropdownItem}
                    >
                      Habilitation
                    </MenuItem>
            ...
            >
              <Paper>
                <ClickAwayListener onClickAway={handleCloseProfile}>
                  <MenuList role="menu">
                    <MenuItem
                      onClick={() => redirectionPage('/profile')}
                    >
                      Profile
                    </MenuItem>
                    <Divider light />
                    <MenuItem
                      onClick={() => redirectionPage('/login')}
                      className={classes.dropdownItem}
                    >
                      Logout
                    </MenuItem>
